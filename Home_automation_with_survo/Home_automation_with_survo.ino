...
void initProperties(){
  const char DEVICE_LOGIN_NAME[]  = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"; //you will get a pdf form ardino iot cloude just copy and past the device id
  const char DEVICE_KEY[]         = "xxxxxxxxxxxxxxxxx";  //you will get a pdf form ardino iot cloude just copy and past the Secret Key
